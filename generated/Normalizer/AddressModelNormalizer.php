...
class AddressModelNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    {
        if ($type !== 'Varspool\\JobAdder\\V2\\Model\\AddressModel') {
            return false;
        }
    ...
    {
        if ($data instanceof \Varspool\JobAdder\V2\Model\AddressModel) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Varspool\JobAdder\V2\Model\AddressModel();
