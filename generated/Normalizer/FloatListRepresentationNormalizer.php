...
class FloatListRepresentationNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    {
        if ($type !== 'Varspool\\JobAdder\\V2\\Model\\FloatListRepresentation') {
            return false;
        }
    ...
    {
        if ($data instanceof \Varspool\JobAdder\V2\Model\FloatListRepresentation) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Varspool\JobAdder\V2\Model\FloatListRepresentation();
        ...
        if (property_exists($data, 'items')) {
            ...
            foreach ($data->{'items'} as $value) {
                $values[] = $this->serializer->deserialize($value, 'Varspool\\JobAdder\\V2\\Model\\FloatSummaryModel', 'raw', $context);
            }
