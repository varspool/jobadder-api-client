...
class JobOrderSalaryRangeModelNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    {
        if ($type !== 'Varspool\\JobAdder\\V2\\Model\\JobOrderSalaryRangeModel') {
            return false;
        }
    ...
    {
        if ($data instanceof \Varspool\JobAdder\V2\Model\JobOrderSalaryRangeModel) {
            return true;
        }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new \Varspool\JobAdder\V2\Model\JobOrderSalaryRangeModel();
